...
const ElectricBorder: React.FC<ElectricBorderProps> = ({
    ...
    useEffect(() => {
        ...
        setFilterId(`turbulent-displace-${uid}`);
    }, []);
    ...
    if (!filterId) return null; // Avoid rendering until we have the ID
    return (
        <div
            ref={rootRef}
        ...
        >
            <svg
                ref={svgRef}
                className="pointer-events-none fixed -top-[10000px] -left-[10000px] h-[10px] w-[10px] opacity-[0.001] max-lg:hidden"
                aria-hidden
                focusable="false"
            >
                <defs>
